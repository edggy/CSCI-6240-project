...
class Channel{
  ...
  public:
    ...
    std::string recv_encrypted(int num_bytes=4096);
    std::string recv_nonce(int num_bytes=4096);
    std::string recv_aes(int num_bytes=4096);
    std::string recv_hmac(int num_bytes=4096);
    std::string recv_data(int num_bytes=4096);
